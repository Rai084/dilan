...
$query = "
    SELECT * FROM posts
    WHERE category = 'sertifikatnasional'";
...
<body>
    <div class="container" style="margin-top: 3%;">
        ...
        <?php
            ...
            echo '<div style="margin-left: auto;margin-right:auto;display: block;"><img draggable="false" src="image/notfound.png" style="-webkit-user-select:none;-khtml-user-select: none;-moz-user-select: none;-o-user-select: none;user-select: none;;width: 300px;margin-left: auto;margin-right:auto;display: block;"></img><br><p style="color: black;text-align:center;font-weight:bold;font-size:35px;">Belum ada diklat yang tersedia<br><p style="text-align:center;color:#919191;">Nanti kalau sudah ada, diklat akan muncul disini</p></p></div>';
        }
        ?>
    </div>
    <footer>
